// lib/services/exercise_video_service.dart
...
class ExerciseVideoService {
  ...
  /// 비디오 파일을 Storage에 업로드하고, Firestore에 메타데이터를 저장합니다.
  ...
  /// 특정 사용자의 업로드된 비디오 목록을 Firestore에서 가져옵니다.
  ...
  /// 비디오를 Storage와 Firestore에서 모두 삭제합니다.
